...
class ParametricSource(Entity):
    ...
    def emit(self):
        ...
        signal_process = Process(self.own, "send_qubit", [self.signal_receiver, signal_pulse_train])
        idler_process = Process(self.own, "send_qubit", [self.idler_receiver, idler_pulse_train])
