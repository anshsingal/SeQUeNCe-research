...
s = BitArray([random.randrange(2) for _ in range(int(2e6))])
...
params = (bits, noise_photons, limit, 
          10*experimental_parameters["classical_powers"], # Change this!
          experimental_parameters["raman_coefficient"],
          experimental_parameters["narrow_band_filter_bandwidth"],
          0.1*experimental_parameters["quantum_channel_attenuation"], # Change this!
          c/(experimental_parameters["classical_communication_rate"]*1e12)/1e3,
          0.1*experimental_parameters["classical_channel_attenuation"], # Change this!
          ...
          20*experimental_parameters["collection_probability"], # Change this!
